<template>
  <div id="dwt-container">
    ...
    <v-tabs id="dwt-control">
      ...
      <v-tab :key="2" @click="handleTabChange(2)">Facial reg (OCR)</v-tab>
      <v-tab-item :key="0">
  ...
  data () {
    return {
      dwt: {
        obj: null,
        id: 'dwtObject',
        licenseKey: "t0068NQAAAHIdHL6GgDZCIx6eu2Ft1PBDT2y68PGL4ubdO//kH1fbkJc2nzuEpKyd3479Yz8AJ11R964XaMbDMzYdojgSMfk="
